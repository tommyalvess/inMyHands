...
export function Categoria(){
    ...
    const [data, setData] = useState<ItemCategoria>();
    ...
    const handleToSave = async () => {
        ...
        try {
            ...
            if (datas.length > 0) {
                ...
                await addDoc(collection(db,  "users", "11979589357", "savemoney", "transaction", "categoria"), {
                    id: keyGenerator(),
    ...
    const renderData = async () => {
       ...
       try {
        ...
        const q = query(collection(db, "users", "11979589357", "savemoney", "transaction", "categoria"))
    ...
    const updateItem = async () => {
       ...
       try {
            ...
            const qR = query(collection(db, "users", "11979589357", "savemoney", "transaction", "categoria"));
            ...
            if (datas.length > 0) {
                ...
                const washingtonRef = doc(db, "users", "11979589357", "savemoney", "transaction", "categoria", `${idTrans}`);
    ...
    async function deleteItem() {
       ...
       await deleteDoc(doc(db, "users", "11979589357", "savemoney", "transaction", "categoria", `${idTrans}`));
       setModalUpdateVisibleDelete(!isModalVisibleDelete)
       renderData()
    ...
    return (
        <SafeAreaView>
            ...
            <View style={{marginHorizontal: 15}}>
                <Header titulo="Categoria" action="SaveMoney" haveIcon={true} btnAction={toggleModal}/>
            </View>
            ...
            <Modal isVisible={isModalVisible}>
                <View style={[estilo.modalBox, {height: 250}]}>
                    ...
                    <View style={{justifyContent: 'center', alignItems: 'center'}}>
                        <Text style={estilo.txtTitleModal}>Adicionar uma categoria!</Text>
                        <TextInput
                            style={estilo.input}

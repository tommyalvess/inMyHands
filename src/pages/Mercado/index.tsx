...
export function Mercado(){
    ...
    const handleToSave = async () => {
        ...
        try {
            ...
            await addDoc(collection(db, "users", "11979589357", "savemoney", "transaction", "mercado"), {
                id: keyGenerator(),
                desc: textInput.trim(),
                check: false
            });
            ...
            console.log("Mercado - error: " + error);
        }
    ...
    const renderData = async () => {
        ...
        try {
         ...
         const q = query(collection(db, "users", "11979589357", "savemoney", "transaction", "mercado"))
    ...
    return (
        <SafeAreaView style={{flex:1}}>
            ...
            <View style={estilo.container}>
                <Header titulo="Lista para Mercado" action="Home" haveIcon={true} btnAction={toggleModal}/>
                <FlatList 
                    data={data}
